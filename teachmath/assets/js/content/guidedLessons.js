const inCell = (value, wide = false) => ({ value, tone: "accent", wide });
const outCell = (value, wide = false) => ({ value, tone: "blue", wide });
const dimCell = (value, wide = false) => ({ value, dimmed: true, wide });
const plainCell = (value, wide = false) => ({ value, wide });
function formula(instruction, expression) {
    return {
        instruction,
        expression,
...
function stage(instruction, stage) {
    return { instruction, stage };
}
function line(instruction, cells, result, ariaLabel) {
...
function pick(instruction, source, selected, ariaLabel) {
    return stage(instruction, {
        rows: [source],
        result: selected,
        ariaLabel
...
export const descriptiveLesson = {
...
export const probabilityLesson = {
    ...
    steps: [
        ...
        pick("取第一組數值。", [inCell("X=0"), inCell("P(X)=0.2", true), dimCell("X=1"), dimCell("P(X)=0.5", true), dimCell("X=2"), dimCell("P(X)=0.3", true)], [outCell("0"), outCell("0.2")]),
        line("把 0 乘以 0.2。", [inCell("0"), plainCell("×"), inCell("0.2")], [outCell("0")]),
        pick("取第二組數值。", [dimCell("X=0"), dimCell("P(X)=0.2", true), inCell("X=1"), inCell("P(X)=0.5", true), dimCell("X=2"), dimCell("P(X)=0.3", true)], [outCell("1"), outCell("0.5")]),
        line("把 1 乘以 0.5。", [inCell("1"), plainCell("×"), inCell("0.5")], [outCell("0.5")]),
        pick("取第三組數值。", [dimCell("X=0"), dimCell("P(X)=0.2", true), dimCell("X=1"), dimCell("P(X)=0.5", true), inCell("X=2"), inCell("P(X)=0.3", true)], [outCell("2"), outCell("0.3")]),
...
export const hypergeometricLesson = {
...
export const criticalValueLesson = {
...
export const conditionalProbabilityLesson = {
...
export const discreteCarSalesLesson = {
...
export const discreteDistributionLesson = {
...
export const binomialIceLesson = {
...
export const hypergeometricDentistLesson = {
...
export const poissonClinicLesson = {
...
export const uniformAnesthesiaLesson = {
...
export const sampleProportionLesson = {
...
export const samplingMeanTLesson = {
...
export const confidenceSalesLesson = {
...
export const requiredSampleSizeLesson = {
