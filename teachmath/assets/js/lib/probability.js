export function diceEventResults(event) {
...
export function complementProbability(probability) {
    validateProbability(probability);
    return 1 - probability;
}
export function independentJointProbability(first, second) {
    validateProbability(first);
    validateProbability(second);
    return first * second;
}
export function summarizeConditionalIndependence(eventProbability, conditionProbability, intersectionProbability, tolerance = 1e-6) {
...
export function summarizeProbabilityDistribution(values, probabilities) {
